...
prompt_email_details=(
    "From the {application},extract the reciever email that is the mail id given in the resume and store it.Only return the email id as a single stirng nothing else.remove the \n and the name with it"
)

prompt_email_details_new=(
    "Only return the name of the candidate as given in the application {application}.And nothing else should be returned other than the name of the candidate."
)
